...
const routes: Routes = [
  ...
  {
    path: 'course/semester/materials/:courseCode/:semester_time',
    loadChildren: () => import('./Teacher/materials/materials.module').then(m => m.MaterialsPageModule),
    canActivate: [AuthGuard],
    data: { roles: [Role.Teacher, Role.Student] }
  },
  {
    path: 'course/semester/add-material/:courseCode/:semester_time',
    loadChildren: () => import('./Teacher/add-material/add-material.module').then(m => m.AddMaterialPageModule),
    canActivate: [AuthGuard],
    data: { roles: [Role.Teacher] }
  },
  {
    path: 'course/semester/delete-material/:courseCode/:semester_time',
    loadChildren: () => import('./Teacher/delete-material/delete-material.module').then(m => m.DeleteMaterialPageModule),
    canActivate: [AuthGuard],
    data: { roles: [Role.Teacher] }
  },
  {
